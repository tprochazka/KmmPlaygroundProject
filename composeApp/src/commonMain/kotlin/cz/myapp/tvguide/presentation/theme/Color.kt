package cz.myapp.tvguide.presentation.theme

import androidx.compose.ui.graphics.Color

/**
 * Material 3 color palette for TV Guide application.
 * 
 * Colors are generated from Material Theme Builder with primary seed color #1976D2 (blue).
 * 
...
// Extended colors for TV Guide specific UI
/** Color for "Live Now" indicator */
val LiveIndicatorColor = Color(0xFFD32F2F)

/** Color for "Coming Soon" indicator */
val ComingSoonColor = Color(0xFFFFA000)

/** Color for HD badge */
val HdBadgeColor = Color(0xFF388E3C)

/** Color for age rating background */
val AgeRatingColor = Color(0xFF757575)
